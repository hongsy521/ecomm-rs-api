...
class ProductCustomRepositoryImplTest extends FullIntegrationTest {
    ...
    private Product createProduct(String name, String brandName, String info, Long price,
        ...
        ColorGroup color = ColorGroup.colorGroupFromKorean(colorGroup);
    ...
    void findProductsBySearchCondition_StockGtZero() {
        createProduct("상품A", "브랜드A", "재고있음", 30000L, "블랙", List.of("태그1", "태그2"), 30L, 300, 4.0,
            4);
    ...
    void findProductsBySearchCondition_PriceRange() {
        createProduct("상품A", "브랜드A", "재고있음", 30000L, "블랙", List.of("태그1", "태그2"), 30L, 300, 4.0,
            4);
        createProduct("상품B", "브랜드B", "재고있음", 50000L, "블랙", List.of("태그1", "태그2"), 30L, 300, 4.0,
            4);
    ...
    void findProductsBySearchCondition_Keyword() {
        createProduct("상품A", "브랜드A", "재고있음", 30000L, "블랙", List.of("태그1", "태그2"), 30L, 300, 4.0,
            4);
        createProduct("상품B", "브랜드B", "재고있음", 50000L, "블랙", List.of("태그3", "태그4"), 30L, 300, 4.0,
            4);
    ...
    void findProductsBySearchCondition_SortBy(){
        createProduct("상품A", "브랜드A", "재고있음", 30000L, "블랙", List.of("태그1", "태그2"), 10L, 300, 3.0,
            4);
        createProduct("상품B", "브랜드B", "재고있음", 50000L, "블랙", List.of("태그3", "태그4"), 30L, 300, 4.0,
            1);
    ...
    void findProductsBySearchCondition_Complex() {
        createProduct("상품A", "브랜드A", "재고없음", 20000L, "블랙", List.of("태그1", "태그2"), 20L, 0, 4.0, 4);
        createProduct("상품B", "브랜드B", "재고있음", 30000L, "화이트", List.of("태그3", "태그4"), 10L, 300, 2.0, 4);
        createProduct("상품C", "브랜드C", "재고있음", 40000L, "블랙", List.of("태그5", "태그6"), 30L, 300, 4.0, 4);
        createProduct("상품D", "브랜드D", "재고있음", 50000L, "화이트", List.of("태그7", "태그8"), 30L, 300, 4.0, 4);
